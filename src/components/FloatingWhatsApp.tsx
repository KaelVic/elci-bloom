...
export function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      <span className="relative inline-flex items-center gap-3 rounded-full bg-rose-deep px-5 py-4 text-background shadow-[var(--shadow-soft)] hover:bg-foreground transition-colors pulse-ring">
